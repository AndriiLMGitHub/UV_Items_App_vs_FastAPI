...
from apps.user.schemas import UserCreate, UserCreateResponse, UserItemResponse, UsersListResponse
...
@router.get("/", response_model=UsersListResponse, summary="Get all users", description="Endpoint to retrieve all users.")
...
@router.post("/", response_model=UserCreateResponse, summary="Create a user", description="Endpoint to create a new user.")
